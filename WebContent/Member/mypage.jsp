...
<div class="mypage-wrap">
  <div class="mypage-content">
    ...
    <div class="mypage-panel mypage-left">
      ...
      <div class="mypage-field"><%= loginUserId %></div>
      ...
      <div class="mypage-reserve-list">
              ...
              try (ResultSet rs = ps.executeQuery()) {
                while (rs.next()) {
                  ...
                  if (posterUrl != null && posterUrl.trim().length() > 0) {
                    posterSrc = ctx + posterUrl; // poster_url이 /media/... 형태라면 OK
                  }
        ...
        <div class="mypage-reserve-item">
          ...
          <button class="mypage-cancel-btn" type="button"
                  onclick="location.href='<%=ctx%>/reserve/cancelReservation.jsp?reservationId=<%=reservationId%>'">
            예매 취소
          </button>
        </div>
