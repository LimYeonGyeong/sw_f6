...
<%
  String ctx = request.getContextPath();   // 예: /Movie2
...
<style>
  ...
  .dropdown .logout{ background:red; color:#fff; }
...
<div class="navbar">
  ...
  <div class="right">
    ...
    <% } else { %>
      <img id="profileBtn" class="profile-img" src="<%=ctx%>/media/user.png" alt="user">
...
<script>
  ...
  if (btn && dd) {
    ...
    window.addEventListener("click", () => dd.classList.remove("show"));
  }
</script>
